...
class SMPL(_SMPL):
    ...
    def __init__(self, *args, **kwargs):
        ...
        JOINT_REGRESSOR_TRAIN_EXTRA = '/data/frankmocap/spin/J_regressor_extra.npy'
...
class SMPLX(_SMPLX):
    ...
    def __init__(self, *args, **kwargs):
        ...
        joints = [constants.JOINT_MAP[i] for i in constants.JOINT_NAMES]
        JOINT_REGRESSOR_TRAIN_EXTRA_SMPLX = '/data/frankmocap/other/J_regressor_extra_smplx.npy'
